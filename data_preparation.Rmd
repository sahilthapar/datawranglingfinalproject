...
library('DT') # For printing data tables
```
...
The description for these can be found [here](https://sahilthapar.github.io/datawranglingfinalproject/data_description.html).
